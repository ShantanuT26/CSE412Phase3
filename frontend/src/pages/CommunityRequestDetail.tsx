      ...
      <div style={commonStyles.layout.container}>
        ...
        >
          ...
          <div style={{ marginTop: '1.5rem' }}>
            ...
            >
              <span style={labelStyle}>Resident who requested:</span>
              <span style={valueStyle}>{data.resident_name}</span>
            </motion.div>
            ...
            <motion.div 
              ...
              whileHover={{ backgroundColor: '#edf2f7' }}
            >
              <span style={labelStyle}>Staff who requested:</span>
              <motion.button
                style={{
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate(`/staff/${data.staff_id}`)}
              >
                {data.staff_name}
              </motion.button>
            </motion.div>
            ...
            <motion.div 
              ...
              whileHover={{ backgroundColor: '#edf2f7' }}
            >
              <span style={labelStyle}>Location in question:</span>
