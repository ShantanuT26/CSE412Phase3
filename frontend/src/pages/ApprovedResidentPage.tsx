        ...
        >
          ...
          <div style={{ marginTop: '1.5rem' }}>
            ...
            <motion.div 
              ...
              whileHover={{ backgroundColor: '#edf2f7' }}
            >
              <span style={labelStyle}>Assigned Apartment:</span>
              <span style={valueStyle}>{assigned_apartment}</span>
            </motion.div>
            ...
            >
              ...
              <motion.span 
                style={{
                  ...
                  borderRadius: '9999px',
                  backgroundColor: status === 'Approved' ? '#c6f6d5' : '#fed7d7',
                  color: status === 'Approved' ? '#22543d' : '#822727',
                  fontWeight: 600,
                  fontSize: '0.75rem',
                  border: `1px solid ${status === 'Approved' ? '#9ae6b4' : '#feb2b2'}`,
                }}
                whileHover={{ y: -1 }}
              >
                {status}
